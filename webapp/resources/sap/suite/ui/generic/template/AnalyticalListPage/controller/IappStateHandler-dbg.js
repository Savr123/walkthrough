...
], function(BaseObject, SelectionVariant, Device, UIState, ControllerExtension, Log, deepEqual) {
	"use strict";
		...
		*/
		...
		function getFilterState() {
			...
			oCustomAndGenericData[genericDataPropertyName] = {
				...
				chartInfo: oState.chartController && oState.chartController._chartInfo
			};
			var oEditStateFilter = oController.byId("editStateFilter");
			if (oEditStateFilter) {
