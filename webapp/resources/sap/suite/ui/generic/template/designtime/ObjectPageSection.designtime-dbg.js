sap.ui.define(["sap/suite/ui/generic/template/changeHandler/util/ChangeHandlerUtils",
	...
	function(Utils, AnnotationChangeUtils, DesigntimeUtils, SectionType) {
		"use strict";
		...
		SectionDesigntime.getDesigntime = function(oElement) {
			...
			if (!oTemplData) {
				jQuery.extend(true, oSectionData, {
			...
			return jQuery.extend(true, oSectionData, oExtendedSectionData);
		};
