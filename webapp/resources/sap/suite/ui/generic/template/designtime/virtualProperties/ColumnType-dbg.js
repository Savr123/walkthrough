sap.ui.define([
	...
	ColumnType.createNewColumn = function(sRecordType, oOldRecord) {
		...
		oRecordTemplate[FORINTENTBASEDNAV] = jQuery.extend({}, oAbstractRecordTemplate,
			{
				Inline: { Bool: "true" },
				Determining: { Bool: "false" },
				Action: { String: "" },
	...
	ColumnType.setColumnType = function(oColumn, sNewColumnType, oChange) {
		...
		switch (sNewColumnType) {
			...
			case COLUMNTYPE_CONNECTEDFIELDS:
				...
				sFullTerm = ColumnType.fixQualifierForNewColumn(oColumn, FIELDGROUP, "DTAGroup", oEntityType);
			...
			case COLUMNTYPE_CHART:
				sFullTerm = ColumnType.fixQualifierForNewColumn(oColumn, CHART, undefined, oEntityType);
			...
			case COLUMNTYPE_CONTACT:
				sFullTerm = ColumnType.fixQualifierForNewColumn(oColumn, CONTACT, undefined, oEntityType);
			...
			case COLUMNTYPE_RATING:
				sFullTerm = ColumnType.fixQualifierForNewColumn(oColumn, DATAPOINT, "Rating", oEntityType);
			...
			case COLUMNTYPE_PROGRESS:
				sFullTerm = ColumnType.fixQualifierForNewColumn(oColumn, DATAPOINT, "Progress", oEntityType);
