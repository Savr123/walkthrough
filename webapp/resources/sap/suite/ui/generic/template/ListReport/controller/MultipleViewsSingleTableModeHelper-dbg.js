sap.ui.define(["sap/ui/base/Object"],
	function(BaseObject) {
		...
		function getMethods(oState, oController, oTemplateUtils, fnSetInitialKey, setModelDataForItem) {
			...
			(function() {
				...
				for (var i = 0; i < aPossibleItems.length; i++) {
					...
					setModelDataForItem(sKey, oItem, oController.byId("listReport").getEntitySet());
				}
		...
		return BaseObject.extend("sap.suite.ui.generic.template.ListReport.controller.MultipleViewsSingleTableModeHelper", {
			constructor: function(oQuickVariantSelection, oState, oController, oTemplateUtils, fnSetInitialKey, mItemData, setModelDataForItem) {
				jQuery.extend(this, getMethods(oState, oController, oTemplateUtils, fnSetInitialKey, setModelDataForItem));
			}
		});
	});
