sap.ui.define(["sap/ui/base/Object",
...
], function(BaseObject, Log, AnnotationHelper) {
	"use strict";
	...
	function getMethods(oComponent, oComponentRegistryEntry) {
		...
		// Check whether the component is currently in a non-draft create scenario
		...
		function getFclProxy() {
			...
			return oFlexibleColumnLayoutHandler ? oFlexibleColumnLayoutHandler.getFclProxy(oTreeNode) : {
				handleDataReceived: oTreeNode.level ? null : jQuery.noop,
				isListAndFirstEntryLoadedOnStartup: oTreeNode.level ? null : jQuery.noop
			};
		}
