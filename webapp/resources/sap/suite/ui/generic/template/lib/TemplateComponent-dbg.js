sap.ui.define(["sap/ui/core/CustomizingConfiguration",
	...
	"sap/ushell/Config"
		...
		reuseComponentHelper, CustomData, StableIdDefinition, StableIdHelper, Log, AnnotationHelper, Config) {
		"use strict";

		// shortcut for sap.ui.core.mvc.ViewType
		var ViewType = coreLibrary.mvc.ViewType;
		var oShellConfig = Config.last("/core/shell");
		// default value for isFiori3Enabled flag is true if shell does not contain a value for oShellConfig.enableFiori3
		var bEnableFiori3 = true;
		if (oShellConfig.enableFiori3 === false) {
			bEnableFiori3 = oShellConfig.enableFiori3;
		}
		...
		var TemplateComponent = UIComponent.extend("sap.suite.ui.generic.template.lib.TemplateComponent", {
			...
			init: function() {
				...
				// adding bEnableFiori3 to access it in js files
				var oUIModel = new JSONModel({
					editable: false,
					enabled: false,
					bEnableFiori3: bEnableFiori3
				});
