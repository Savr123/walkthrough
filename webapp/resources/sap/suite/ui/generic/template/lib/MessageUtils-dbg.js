...
sap.ui.define(["sap/ui/generic/app/util/MessageUtil",
	"sap/base/Log"
		...
		function fnNavigateFromMessageTitleEvent(oCommonUtils, oEvent) {
		...
		/*
		This function shows the given success message in case no transient messsage is available(in the message model). 
		If transient messages are avaialable this function does nothing,
