sap.ui.define(["sap/ui/base/Object",
	...
	"sap/suite/ui/generic/template/lib/GroupHeaderFormatter",
	"sap/ui/generic/app/navigation/service/SelectionVariant",
	"sap/ui/core/mvc/Controller",
	"sap/base/Log",
	"sap/suite/ui/generic/template/lib/MessageUtils"
], function(BaseObject, Event, MessageBox, Table, Sorter,
	testableHelper, JSONModel, coreLibrary, AnnotationHelper, modelHelper, GroupHeaderFormatter, SelectionVariant, Controller, Log, MessageUtils) {
...
//			}
		...
		function onListNavigate(oEventOrSource, oState, onListNavigationExtension, oBindingContext, bIsProgrammatic) {
			...
			if (bIsProgrammatic){
				...
				oCommonUtils.processDataLossConfirmationIfNonDraft(onListNavigateImpl.bind(null, oEventSource, oEventParameters, oState, onListNavigationExtension, oBindingContext), jQuery.noop, oState);
			}
		}
...
//			}
		...
		function onDeterminingDataFieldForAction(oEvent, oTable) {
			...
			if (oCustomData.ActionFor) {
				aContexts = oTable ? oCommonUtils.getSelectedContexts(oTable) : [oView.getBindingContext()];
			}
		...
		function onCallActionFromToolBar(oEvent, oState) {
			...
			if (oCustomData.ActionFor) {
				aContexts = oCommonUtils.getSelectedContexts(oControl);
			}
