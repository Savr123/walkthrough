sap.ui.define([
    ...
    SelectFunctionDialog.prototype._createFunctionSelectionDropDown = function (selectFunction) {
        ...
        this.functionSelect = new sap.m.Select({
            ...
            change: function (oEvent) {
                ...
                if (that._selectFunctionSelected === Constants.SELECT) {
                ...
                if (that.dataObjectId && that._selectFunctionSelected && (that._count || that._selectFunctionSelected === Constants.SELECT)) {
    ...
    SelectFunctionDialog.prototype._setDataObjectInfoForWhereConditionAutoSuggestion = function () {
        if (this.dataObjectId) {
            var dataObjectId = this._returnDataObjectBasedOnCommonAssociationSelection(this.dataObjectId, this._getSelectedAttributeJsons())
    ...
    SelectFunctionDialog.prototype._createCountField = function (sAriaValue) {
        ...
        }).addStyleClass("sapAstSelectCountField");
    ...
    SelectFunctionDialog.prototype._createSelectFunctionDialog = function (data, callBack, AstExpressionLanguage, dialogOpenedCallbackReference, jsonData) {
        ...
        if (jsonData) {
            ...
            if (this.dataObjectId) {
                ...
                var association = this._returnAssociationBasedOnCardinality(dataObjectAssociationInfo);
    ...
    SelectFunctionDialog.prototype._returnAssociationBasedOnCardinality = function (associationInfo) {
        if (associationInfo) {
    ...
    SelectFunctionDialog.prototype._createJson = function () {
        ...
        if (association) {
            whereExpressionId = this._addAssociationIdToWhere(this._whereExpressionId, association);
        }
        var json = {
