...
sap.ui.define(["sap/ui/thirdparty/jquery",
		...
		var TextRule = RuleBase.extend("sap.rules.ui.TextRule", {
			...
			_formElementsFactory: function (sId, oContext) {
                ...
                var oExpressionControl = this._getExpressionAdvancedText(oContext, expression, businessDataType, sAttributeId);
			...
			_getExpressionAdvancedText: function (oContext, expression, businessDataType, attributeId) {
				...
				if (this.getAstExpressionLanguage()) {
					...
					if(displayExpression && displayExpression.relString){
					    displayExpression.relString = displayExpression.relString.replace(/{/g, "\\{").replace(/}/g, "\\}");   
					}
					if (attributeId) {
