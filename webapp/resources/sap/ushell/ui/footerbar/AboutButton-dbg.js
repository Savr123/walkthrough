...
sap.ui.define([
    ...
    AboutButton.prototype.showAboutDialog = function () {
        var metaData = AppConfiguration.getMetadata(), oApplication = sap.ushell.Container.getService("AppLifeCycle").getCurrentApplication(), sProductVersion = sap.ushell.Container.getLogonSystem().getProductVersion(), sClientRole = this._getClientRoleDescription(), oSimpleForm = new SimpleForm({
