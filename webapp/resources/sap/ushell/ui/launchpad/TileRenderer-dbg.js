...
sap.ui.define([
    ...
    TileRenderer.render = function (oRm, oControl) {
        ...
        var oTileContainer = Config.last("/core/home/gridContainer") && oControl.getParent().getParent() || oControl.getParent(),
        ...
        // n case of Action Mode we don't need Additional Container
        // y this if we check if we are in the edit mode or not
        if (!oControl.getTileActionModeActive()) {
            oRm.write("<div");
            oRm.addClass("sapUshellTileWrapper");
            oRm.writeClasses();
