...
sap.ui.define([
    ...
    GridContainer.prototype.init = function () {
        ...
        layoutXL: new Ui5GridContainerSettings({
            ...
            columnSize: "5.25rem",
            gap: "0.5rem",
            autoFlow: "RowDense" // TODO: this is not yet implemented by the GridContainer which is why this section is commented out
        })*/
        }));
    ...
    /**
     * Add Layout to the input item. The input item should only be a sap.ui.integration.widgets.Card or sap.ushell.ui.launchpad.Tile
     *
     * @param {sap.ui.core.Control} oItem An item which can be a tile or card
     * @private
     */
