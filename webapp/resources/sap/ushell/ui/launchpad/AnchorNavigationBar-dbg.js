...
sap.ui.define([
    ...
    AnchorNavigationBar.prototype.updateVisibility = function () {
        ...
        while (i < aGroups.length && visibleGroupsCounter <= 1) {
        ...
        if (visibleGroupsCounter === 1) {
            ...
            this.$().parent().next().addClass("sapUshellSectionNoTop");
        } else {
            this.$().removeClass("sapUshellAnchorNavigationBarInvisible");
            this.$().parent().next().removeClass("sapUshellSectionNoTop");
        }
    };
    ...
    AnchorNavigationBar.prototype.onAfterRendering = function () {
        ...
        if (this._bIsRenderedCompletely) {
            this.reArrangeNavigationBarElements();
            selectedItemIndex = this.getSelectedItemIndex() || 0;
    ...
    AnchorNavigationBar.prototype._scrollToGroupByGroupIndex = function (groupIndex, speed) {
        var oContainer = document.documentElement.querySelector(".sapUshellAnchorNavigationBarItems");
    ...
    AnchorNavigationBar.prototype._getOverflowLeftArrowButton = function () {
        this.oOverflowLeftButton = new Button({
            ...
            tooltip: resources.i18n.getText("scroll_beginning"),
            press: function () {
    ...
    AnchorNavigationBar.prototype._getOverflowRightArrowButton = function () {
        this.oOverflowRightButton = new Button({
            ...
            tooltip: resources.i18n.getText("scroll_end"),
            press: function () {
