...
sap.ui.define([
    ...
    "sap/m/ListItemBase"
], function (resources, AccessibilityCustomData, ListItemBase) {
    "use strict";
     ...
     * @class User Header Action Item of the Shell.
     ...
     */
    UserStatusItem = ListItemBase.extend("sap.ushell.ui.launchpad.UserStatusItem", /** @lends sap.ushell.ui.launchpad.UserStatusItem.prototype */ {
        metadata: {
            properties: {
                status:
                    { type: "object", group: "Appearance" },
                visible:
                ...
                enabled:
                    { type: "boolean", group: "Appearance", defaultValue: true },
                image:
                    { type: "object", group: "Appearance", defaultValue: null }
            },
            aggregations: {
    ...
    UserStatusItem.prototype.onclick = function (oEvent) {
        this.firePress();
        // IE always interprets a click on an anker as navigation and thus triggers the beforeunload-event on the window.
        // Since a ShellHeadItem never has a valid href-attribute, the default behavior should never be triggered
    ...
    UserStatusItem.prototype.STATUS_ENUM = {
        AVAILABLE:
            { text: translationBundle.getText("userStatus_available"), id: 0, styleClass: "sapUshellUserStatusAvailableIndicator", status: "AVAILABLE" },
        AWAY:
            { text: translationBundle.getText("userStatus_away"), id: 1, styleClass: "sapUshellUserStatusAwayIndicator", status: "AWAY" },
        BUSY:
            { text: translationBundle.getText("userStatus_busy"), id: 2, styleClass: "sapUshellUserStatusBusyIndicator", status: "BUSY" },
        APPEAR_OFFLINE:
            { text: translationBundle.getText("userStatus_appearOffline"), id: 3, styleClass: "sapUshellUserStatusAppearOfflineIndicator", status: "APPEAR_OFFLINE" },
        SIGNOUT:
            { text: translationBundle.getText("userStatus_signOut"), id: 4, styleClass: "sapUshellUserSignOutExp sapUserStatusText", status: "SIGNOUT" }
    };
    ...
    UserStatusItem.prototype.setImage = function () { };
