        ...
        jQuery.each(aTiles, function () {
            ...
            if (this.getVisible) {
                if (this.isA("sap.ui.integration.widgets.Card")) {
                    ...
                    oRm.addClass("sapUshellTile sapUshellLockedTile sapUshellCard");
                    oRm.writeClasses();
                    // In the css class "sapUshellTile", the min-width and min-height are set to 11rem,
                    // which are not suitable cards eg. 1*1 cards, therefore style = "min-width: 0rem; min-height: 0rem;" is added.
