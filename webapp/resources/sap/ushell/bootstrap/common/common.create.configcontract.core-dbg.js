...
function (URI) {
    ...
    function fnCreateConfigContract (oMergedSapUshellConfig) {
        ...
        /**
         * For a given boolean config value, check if the given URL parameter is set to "true".
         * If yes, true is returned. If no, the given bConfigValue is returned.
         *
         * @param {string} sUrlParam The url param
         * @param {boolean} bConfigValue The value from the config - must be a boolean
         * @returns {boolean|*} The result
         */
        function getUrlParameter (sUrlParam, bConfigValue) {
            var sParamValue = (new URI()).query(true)[sUrlParam];
            return sParamValue && sParamValue === "true" ? true : bConfigValue;
        }
        ...
        var oConfigDefinition = {
            core: { // the unified shell core
                extension: {
                    ...
                    PageComposition: getUrlParameter(
                        "sap-ushell-xx-pagecomposer",
                        getConfigValue("ushell/extension/pageComposition/enabled", false)
                    )
                },
                navigation: {
                ...
                pageComposition: {
                    ...
                    editMode: false,
                    transport: {
                        support: getConfigValue("ushell/extension/pageComposition/transport/support", false),
                        module: getConfigValue("ushell/extension/pageComposition/transport/module", ""),
                        serviceUrl: getConfigValue("ushell/extension/pageComposition/transport/serviceUrl", "")
                    }
                },
                shellHeader: {
                    application: {},
