...
sap.ui.define([
...
], function (PersonalizationProcessor, ObjectPath, jQuery, Log, isPlainObject) {
    ...
    CommonDataModel.prototype._ensureStandardVizTypesPresent = function (oSite) {
        ...
        if (!oSite.vizTypes[O_STANDARD_VIZ_TYPES.STATIC_LAUNCHER]) {
            ...
            oSite.vizTypes[O_STANDARD_VIZ_TYPES.STATIC_LAUNCHER] = jQuery.sap.loadResource("sap/ushell/components/tiles/cdm/applauncher/manifest.json");
        }

        if (!oSite.vizTypes[O_STANDARD_VIZ_TYPES.DYNAMIC_LAUNCHER]) {
            // TODO: migration not possible. jQuery.sap.loadResource is deprecated and private.
            oSite.vizTypes[O_STANDARD_VIZ_TYPES.DYNAMIC_LAUNCHER] = jQuery.sap.loadResource("sap/ushell/components/tiles/cdm/applauncherdynamic/manifest.json");
        }

        if (!oSite.vizTypes[O_STANDARD_VIZ_TYPES.CARD]) {
            // TODO: migration not possible. jQuery.sap.loadResource is deprecated and private.
            oSite.vizTypes[O_STANDARD_VIZ_TYPES.CARD] = jQuery.sap.loadResource("sap/ushell/services/_CommonDataModel/vizTypeDefaults/cardManifest.json");
        }
