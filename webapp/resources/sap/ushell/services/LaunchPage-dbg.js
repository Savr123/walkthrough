...
], function (ContentExtensionAdapterFactory, jQuery, resources) {
    "use strict";
                ...
                if (aGroups.length > 0) {
                    aGroups = aGroups.filter(function (group) {
                        if (bGetAll !== undefined && bGetAll === true) {
                            return that.isGroupVisible(group);
                        } else {
                        ...
                        .map(function (group) {
                            return {
                                title: (group === oDefaultGroup && resources.i18n.getText("my_group")) || that.getGroupTitle(group),
                                object: group
                            };
                        });
                }
