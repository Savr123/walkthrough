...
sap.ui.define([], function () {
    ...
    var A_VIRTUAL_INBOUNDS = [
        ...
        },
        {
            ...
            resolutionResult: {
                applicationType: "SAPUI5",
                ui5ComponentName: "sap.ushell.applications.PageComposerLegacy",
                additionalInformation: "SAPUI5.Component=sap.ushell.applications.PageComposerLegacy",
                url: sap.ui.require.toUrl("sap/ushell/applications/PageComposerLegacy"),
                loadCoreExt: true,
                loadDefaultDependencies: false
            }
        },
