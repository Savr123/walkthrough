...
sap.ui.define([
    ...
    Renderer.prototype.createContent = function () {
        ...
        oView = sap.ui.view("mainShell", {
            ...
            //height: "100vh", // TODO: removed temporary until vh units are allowed in 1.56, see also ShellLayout.less
            viewData: viewData
        });
     ...
     *
     * @param {string} sId ID of the element to add to the Tool Area.
     * @param {boolean} bCurrentState if true, add the current ToolAreaItems only to the current instance of the rendering of the shell.
     ...
     * </pre>
     *
     * @param {String[]} aIds List of ID elements to that should be added to the Me Area options bar.
     ...
     *   If no launchpad state is provided, the content is added in all states.
     * @param {boolean} bIsFirst If set to true, displays the button as the first item.
     * @since 1.30
     * @public
     */
     ...
     * We do not recommend using it on a standard launchpad element, as this may interfere with the standard launchpad functionality.
     *
     * @param {String[]} aIds the Ids of the sap.ushell.ui.shell.ToolAreaItem control to remove.
     * @param {boolean} bCurrentState if true, remove the current control only from the current rendered shell state.
     * @param {String[]} aStates list of the sap.ushell.renderers.fiori2.Renderer.LaunchpadState in which to remove the control.
     *   (Only valid if bCurrentState is set to false)
     *   @see LaunchpadState
    ...
    /**
     * Hides an action button from the options bar of the Me Area in the SAP Fiori launchpad, in the given launchpad states (LaunchpadState).
