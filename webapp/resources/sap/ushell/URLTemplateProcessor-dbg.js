...
sap.ui.define([
    ...
    function buildDefinitionParameterSet (oParamDefs, oSite, sDefaultNamespace) {
        var bMergeWithSpecified = oParamDefs && oParamDefs.mergeWith;
        var oParamNames = oParamDefs && oParamDefs.names;
        if (!bMergeWithSpecified) {
            return oParamNames;
        }

        var oParsedPath = oTemplateParameterParser.parsePath(sDefaultNamespace, oParamDefs.mergeWith);
        ...
        return mergeObject(oParamDefsBase, oParamNames);
    }
