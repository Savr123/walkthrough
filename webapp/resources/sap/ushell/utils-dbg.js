...
sap.ui.define([
    ...
    // "sap/ushell/resources" // system breaks if this dependency is loaded here
], function (
    Parameters,
    URI,
    fnClone,
     ...
     */
    utils.updateProperties = function (oTarget, oSource) {
     ...
     * @private
     */
    utils.getNestedObjectProperty = function (aObjects, oAccessPath, oDefault) {
        // Check inputs
        ...
        var oNestedObjectProperty = aObjects.reduce(function (oAMember, oObject, iIndex) {
            return oAMember || utils.getMember(oObject, aAccessPaths[iIndex]);
        }, undefined);
     ...
     * @returns {boolean} true iff the resolution result represents a response which is to be treated by the Fiori Desktop client
     * @private
     */
