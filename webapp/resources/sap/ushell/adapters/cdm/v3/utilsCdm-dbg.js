...
sap.ui.define([
    ...
    function mapOne (sKey, oSrc, oApp, oVisualization, oVisualizationType, oSite) {
        ...
        oInbound.title = getNestedObjectProperty(
            [oVizConfig, oSrc, oApp],
            ["sap|app.title", "title", "sap|app.title"]
        );
        oInbound.info = getNestedObjectProperty(
            [oVizConfig, oSrc, oApp],
            ["sap|app.info", "info", "sap|app.info"]
        );
        oInbound.icon = getNestedObjectProperty(
            [oVizConfig, oSrc, oApp],
            ["sap|ui.icons.icon", "icon", "sap|ui.icons.icon"]
        );
        oInbound.subTitle = getNestedObjectProperty(
            [oVizConfig, oSrc, oApp],
            ["sap|app.subTitle", "subTitle", "sap|app.subTitle"]
        );
        oInbound.shortTitle = getNestedObjectProperty(
            [oVizConfig, oSrc, oApp],
