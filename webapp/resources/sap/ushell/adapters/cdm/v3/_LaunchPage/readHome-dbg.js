...
sap.ui.define([
     ...
     */
    function isCard (oResolvedObjects, oItem) {
     ...
     *      Returns true if form factor is supported
     */
    function getInbound (oAppDescriptor, sInboundId) {
        var oInbound = oAppDescriptor["sap.app"].crossNavigation.inbounds[sInboundId];

        return oInbound ? {key: sInboundId, inbound: oInbound} : undefined;
    }
