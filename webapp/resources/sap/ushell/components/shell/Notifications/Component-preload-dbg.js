    ...
    sap.ui.jsview("sap.ushell.components.shell.Notifications.Settings", {
        ...
        createSwitchControlBar: function () {
            ...
            if (bEligibleDeviceForPreview === true) {
                oEnablePreviewLabel = new Label("enablePreviewLabel", {
                    text: oResourceBundle.getText("Show_Preview_in_Home_Page_title"),
                    visible: "{/flags/previewNotificationVisible}"
                });

                oPreviewSwitch = new Switch("enablePreviewSwitch", {
                ...
                oEnablePreviewHBox = new FlexBox({
                    items: [
                        oPreviewSwitch,
                        oEnablePreviewLabel
                    ]
