...
sap.ui.define([
    ...
    oUtils.roleSelectOnValueHelpRequest = function (oController/*, oEvent*/) {
        var oView = oController.getView(), sTitle = oUtils.getResourceBundleModel().getResourceBundle().getText("configuration.navigation_provider_role"), oRoleSelector, oInstanceSelector, sValue, oSelectorModel = new JSONModel(), oSelectDialog = new TableSelectDialog("role_select_dialog", {
            title: sTitle,
