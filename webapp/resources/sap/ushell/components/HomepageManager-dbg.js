...
sap.ui.define([
    ...
    "sap/ushell/Config" // TODO: remove this dependency after the pages Demo at 12.07.2019
], function (
    jQuery,
    BaseObject,
    Device,
    ...
    return BaseObject.extend("sap.ushell.components.HomepageManager", {
        ...
        _addFLPActionsToTile: function (oTile) {
            ...
            if (bLinkPersonalizationSupportedForTile) {
                // TODO: remove the following if-clause after the pages demo at 12.07.2019
                if (!Config.last("/core/extension/PageComposition")) {
        ...
        */
        ...
        addTileToGroup: function (sGroupPath, oTile) {
            ...
            if (oGroup.isDefaultGroup && oGroup.tiles.length + oGroup.links.length === 1) {
                var oAnchorNavigationBar = this.getDashboardView().oAnchorNavigationBar;
                window.setTimeout(function () {
                    oAnchorNavigationBar.updateVisibility();
                }, 0);
            }
        },
        ...
        */
        ...
        deleteTilesFromGroup: function (sGroupId, aRemovedTilesIds) {
            ...
            if (oGroup.isDefaultGroup && oGroup.tiles.length + oGroup.links.length === 0) {
                var oAnchorNavigationBar = this.getDashboardView().oAnchorNavigationBar;
                window.setTimeout(function () {
                    oAnchorNavigationBar.updateVisibility();
                }, 0);
