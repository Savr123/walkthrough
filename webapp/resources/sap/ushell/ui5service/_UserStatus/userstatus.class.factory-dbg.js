        ...
        return function (oSettings) {
            ...
            var UserStatus = Service.extend("sap.ushell.ui5service.UserStatus", /** @lends sap.ushell.ui5service.UserStatus# */ {
                init: function () {
                    ...
                    // Only one component can set/get at a given time.
                    // Here we try to avoid that no yet-to-be-destroyed apps call set/get methods by giving priority to the last instantiated component.
                ...
                /**
                 * Sets the id of the active component, that is, the component allowed to call public methods of this service.
                 * This method is mainly here for supportability purposes.
                 *
                 * @param {string} sId The id of the active component.
                 * @private
                 * @since 1.38.0
                 */
                 ...
                 * This method is mainly here for supportability purposes.
                 *
                 * @returns {string} The id of the component currently active in the Launchpad.
                 * @private
                 * @since 1.38.0
                 */
                 ...
                 * This method is mainly here for supportability purposes.
                 *
                 * @returns {object} The event provider
                 * @private
                 * @since 1.38.0
                 */
                 ...
                 *
                 * <pre>
                 * IMPORTANT: this method must not rely on its context when called or produce side effects.
                 * </pre>
                 *
                 * @param {variant} vArg Any value.
                 * @param {string} sMethodName The name of the method that called this function.
                 * @returns {boolean} Whether <code>vArg</code> is a string.
                 *   Logs an error message reporting <code>sMethodName</code> in case <code>vArg</code> is not a string.
                 * @private
                 * @since 1.38.0
                 */
                ...
                /**
                 * Ensures that the given argument is a function, logging an error message in case it's not.
                 *
                 * <pre>
                 * IMPORTANT: this method must not rely on its context when called or produce side effects.
                 * </pre>
                 ...
                 * @param {variant} vArg Any value.
                 * @param {string} sMethodName The name of the method that called this function.
                 * @returns {boolean} Whether <code>vArg</code> is a function.
                 *   Logs an error message reporting <code>sMethodName</code> in case <code>vArg</code> is not a function.
                 * @private
                 * @since 1.38.0
                 */
                ...
                /**
                 * Ensures that the given argument is a string, logging an error message in case it's not.
                 *
                 * <pre>
                 * IMPORTANT: this method must not rely on its context when called or produce side effects.
                 * </pre>
                ...
                /**
                 * Wraps a given public service interface method with a check that determines whether the method can be called.
                 * This helps preventing cases in which calling the method would disrupt the functionality of the currently running app.
                 * For example, this check would prevent a still alive app to change the header title while another app is being displayed.
                 *
                 * @param {object} oPublicServiceInstance The instance of the public service interface.
                 * @param {string} sPublicServiceMethod The method to be wrapped with the check.
                 * @private
                 * @since 1.38.0
                 */
                 ...
                 *     <li>Register the component that called <code>.getService</code> as the currently active component.
                 *   </ul>
                 *
                 * @param {sap.ui.base.Interface} oPublicServiceInstance The public service interface.
                 * @private
                 * @since 1.38.0
                 */
                _amendPublicServiceInstance: function (oPublicServiceInstance) {
                    ...
                    if (typeof oContext === "undefined") {
                        // ServiceFactoryRegistry#get static method was used on the service factory to obtain the service.
                        // Don't record the currently active component so that future call from an active app succeed. E.g., on view change.
                        return;
                    }

                    // must re-bind all public methods to the public interface instance, as they would be otherwise called in the context of the service instance.
                ...
                /**
                 * Returns version number in use (e.g. 2 for Fiori 2.0).
                 * Will be used for checking whether the Fiori 2.0 header should be used or not.
                 *
                 ...
                 * @returns {sap.ushell.ui.launchpad.UserStatusItem} UserStatusItem
                 * @since 1.46.0
                 * @private
                 */
                ...
                _showLegalPopup: function () {
                    ...
                    setTimeout(function () {
                        var sTextAlign = sap.ui.getCore().getConfiguration().getRTL() ? "Left" : "Right",
                            sEnableLabelWidth = Device.system.phone ? "auto" : "14rem",
                            sStatusLabelWidth = Device.system.phone ? "auto" : "10rem";

                        var enableStatusLabel = new Label({
                            text: resources.i18n.getText("enableStatusMessageBoxFld") + ":",
                            width: sEnableLabelWidth,
                            textAlign: sTextAlign
                        });
                        var enableStatusSwitch = new Switch("enableStatusSwitch", {
                            type: SwitchType.Default,
                            change: function (oEvent) {
                                signInAsPopOver.setEnabled(oEvent.mParameters.state);
                                signInAsPopOver.$().attr("tabindex", oEvent.mParameters.state ? 0 : -1);
                            }
                        });
                        var fboxEnableStatus = new FlexBox({
                            alignItems: "Center",
                            direction: "Row",
                            items: [
                                enableStatusLabel,
                        ...
                        var signInAsLabel = new Label({
                            text: resources.i18n.getText("userStatusMessageBoxDropdownLabelFld") + ":",
                        ...
                        signInAsPopOver.$().attr("tabindex", signInAsPopOver.getEnabled() ? 0 : -1);
                        var legalTextLine1 = new Text({
                            text: resources.i18n.getText("userStatusMessageBoxInfoTextLine1")
                        }).addStyleClass("sapUshellUserStatusLegalTextLine").addStyleClass("sapUshellUserStatusLegalTextFirstLine");
                        var legalTextLine2 = new Text({
                            text: resources.i18n.getText("userStatusMessageBoxInfoTextLine2")
                        }).addStyleClass("sapUshellUserStatusLegalTextLine");
                        var fboxStatusPopOver = new FlexBox({
                            alignItems: "Center",
                            direction: "Row",
                            items: [
                                signInAsLabel,
                        ...
                        var layout = new VerticalLayout("userStatusDialogLayout", {
                            content: [fboxEnableStatus, fboxStatusPopOver, legalTextLine1, legalTextLine2]
                        });

                        var saveButton = new Button("saveButton", {
                        ...
                        var dialog = new Dialog("agreementMessageBox", {
                            title: resources.i18n.getText("userStatusAgreementMessageBoxTitle"),
                            modal: true,
