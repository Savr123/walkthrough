...
sap.ui.define([
...
], function (URI, oUtils, URLTemplateProcessor, oApplicationTypeUtils, oSystemAlias, oWdaResolution, oGuiResolution, oCSTRUtils, oParameterMapping) {
    "use strict";
    ...
    function generateURLTemplateResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        var oRuntime = {
            // the inner app route
            innerAppRoute: oMatchingTarget.parsedIntent.appSpecificRoute || undefined,
    ...
    function compactURLParameters (sUrlExpanded) {
        return new Promise(function (fnResolve, fnReject) {
            ...
            sap.ushell.Container.getService("ShellNavigation")
                .compactParams(oParams, ["sap-language", "sap-theme", "sap-ui-app-id"] /* retain list */, undefined /* no Component*/ , true /*transient*/ )
    ...
    function generateURLResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        .then(function (sUrlWithoutParameters) {
            var sParameters = oApplicationTypeUtils.getURLParsing().paramsToString(oEffectiveParameters);
            return oApplicationTypeUtils.appendParametersToUrl(sParameters, sUrlWithoutParameters);
