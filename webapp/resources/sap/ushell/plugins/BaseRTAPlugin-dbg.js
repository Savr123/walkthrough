	...
	var BaseRTAPlugin = Component.extend("sap.ushell.plugins.BaseRTAPlugin", {
		...
		_handleFlexDisabledOnStart: function () {
			...
			function (
				...
				var sDocuLink = "https://help.sap.com/viewer/4fc8d03390c342da8a60f8ee387bca1a/1902.500/en-US/ef97b2485aa34a8890f4d51e5c2b15a8.html",
					sHeaderText = this.i18n.getText("HEADER_FLEX_DISABLED"),
					sMessageText = this.i18n.getText("MSG_FLEX_DISABLED"),
					sLinkText = this.i18n.getText("MSG_FLEX_DISABLED_LINK_TEXT"),
					sLinkDescription = this.i18n.getText("MSG_FLEX_DISABLED_LINK_DESC"),
					sButtonText = this.i18n.getText("BUTTON_FLEX_DISABLED"),
					oHBox = new HBox({
						items: [
							new Text({text: sLinkDescription, renderWhitespace: true}),
							new Link({text: sLinkText, href: sDocuLink, target: "_blank", emphasized: true, wrapping: true})
						]
					}),
					oVBox = new VBox({
						items: [
							new Text({text: sMessageText, renderWhitespace: true}),
							oHBox
						]
					}),
					oDialog = new Dialog({
		...
		_onAdapt: function () {
			var bSupportedBrowser = (
				(Device.browser.msie && Device.browser.version > 10) ||
