...
sap.ui.define([
    ...
    "sap/ui/Device",
    "sap/ui2/srvc/utils"
], function (sBootPath, oXhrLogonLib, oUshellUtils, oAbapUtils, fnRequestServerConfig, oStartupHandler, oPageSetHandler, oXhrHandler) {
    "use strict";
    ...
    function processTheme (oStartupTheme, sSystemThemeRoot) {
        ...
        if (isUrlThemeSupplied()) {
            ...
            if (oBootTheme.root) {
                sap.ui.getCore().setThemeRoot(oBootTheme.theme, oBootTheme.root + "/UI5/");
            }
