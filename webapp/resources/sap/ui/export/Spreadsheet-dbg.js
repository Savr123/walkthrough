...
sap.ui.define([
	...
	function(jQuery, library, ExportDialog, EventProvider, Device, SpreadsheetExport, Log, assert, ExportUtils) {
		 ...
		 *          <li><code>version</code> (string) - Application version that creates the XLSX document (default: "1.69.1")</li>
		 ...
		 *
		 * @param {ArrayBuffer} oEvent.getParameters.data - The data parameter contains the generated file
		 *
		 * @since 1.61
		 * @public
		 */
		...
		/**
		 * Attaches event handler <code>fnFunction</code> to the {@link sap.ui.export.Spreadsheet beforeSave}
		 * event of this <code>sap.ui.export.Spreadsheet</code>.</br>
		 * When called, the context of the event handler (its this) will be bound to <code>oListener</code> if specified,
		 ...
		 *
		 * @returns {sap.ui.export.Spreadsheet} - Reference to this in order to allow method chaining
		 *
		 * @function
		...
		Spreadsheet.prototype.attachBeforeSave = function(oData, fnHandler, oListener) {
			this.attachEvent('beforeSave', oData, fnHandler, oListener);
			return this;
		};
		...
		Spreadsheet.prototype.detachBeforeSave = function(fnHandler, oListener) {
			this.detachEvent('beforeSave', fnHandler, oListener);
			return this;
		};
		...
		Spreadsheet.prototype.build = function() {
			...
			var mParameters = this.mSettings;
			...
			return new Promise(function (fnResolve, fnReject) {
				...
				function onmessage(message) {
					...
					if (message.finish) {
						...
						var executeDefaultAction = spreadsheet.fireEvent('beforeSave', {
							data: message.data
						}, true, true);
