...
sap.ui.define([
	...
	GridTableType.updateSelection = function(oTable, fnRowSelectionChange) {
		oTable._oTable.destroyPlugins();
		oTable._oTable.detachRowSelectionChange(fnRowSelectionChange, oTable);
		oTable._oTable.setSelectionMode(TableTypeBase.getSelectionMode(oTable));

		if (oTable.getSelectionMode() === "Multi") {
			oTable._oTable.addPlugin(this.createMultiSelectionPlugin(oTable.getId(), [
				fnRowSelectionChange, oTable
			]));
		} else {
			oTable._oTable.attachRowSelectionChange(fnRowSelectionChange, oTable);
		}
	};
