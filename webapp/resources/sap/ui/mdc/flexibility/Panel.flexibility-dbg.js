...
sap.ui.define([
	...
	return {
		createChanges: function(oPanel, oAppComponent, aDeltaMItems) {
				...
				applyChange: function(oChange, oPanel, mPropertyBag) {
					...
					return new Promise(function(resolve) {
						...
						sap.ui.require([
							...
							var oItem = mPropertyBag.modifier.createControl("sap.ui.mdc.base.info.PanelItem", mPropertyBag.appComponent, mPropertyBag.view, oMetadataOfNewItem.id, {
