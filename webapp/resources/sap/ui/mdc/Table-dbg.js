	...
	var Table = Control.extend("sap.ui.mdc.Table", {
		...
		metadata: {
			...
			properties: {
				...
				/**
				 * The metadataInfo object containing collection, model and other relevant information using which the delegate can function properly.
				 * The metadataInfo is processed and used by the delegates and not by the control itself. DO not bind/modify the property. Once the
				 * metadataInfo is used - this property may never be used again
				 *
				 * @experimental
				 */
				metadataInfo: {
				...
				/**
				 * The rowsBindingInfo object containing binding related info for binding the rows/items of the table. Changes to this property are only
				 * reflected once the next complete rebind on the table occurs. DO NOT add filters/sorters here - as they will not be shown on the
				 * p13n panels of table.
				 *
				 * @experimental
				 */
				rowsBindingInfo: {
				...
				/**
				 * Binds the table automatically after initial creation -or- table re-creation using relevant metadata info
				 */
				autoBindOnInit: {
					type: "boolean",
					group: "Misc",
...
// GridTable
	...
	Table.prototype.bindRows = function(oBindingInfo) {
		...
		if (this.oTableDelegate) {
			this.oTableDelegate.updateBindingInfo(this.getMetadataInfo(), oBindingInfo);
		}
		this._oBindingInfo = oBindingInfo;
		if (this._oTable && oBindingInfo.path) {
	...
	Table.prototype.rebindTable = function() {
		...
		this._oBindingInfo = this.getRowsBindingInfo() || {};
