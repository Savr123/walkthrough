...
sap.ui.define([
	 ...
	 */
	var InParameter = Element.extend("sap.ui.mdc.base.InParameter", /** @lends sap.ui.mdc.base.InParameter.prototype */
	{
		metadata: {
			library: "sap.ui.mdc",
			properties: {
	...
	function _handleModelContextChange(oEvent) {
		...
		if (oBinding) {
			...
			if (oModel && oModel.isA("sap.ui.mdc.base.ConditionModel")) {
