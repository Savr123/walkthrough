...
sap.ui.define([
	...
	var Panel = XMLComposite.extend("sap.ui.mdc.base.info.Panel", /** @lends sap.ui.mdc.base.info.Panel.prototype */
	{
		metadata: {
			library: "sap.ui.mdc",
			designtime: "sap/ui/mdc/designtime/base/info/Panel.designtime",
	...
	Panel.prototype.openSelectionDialog = function(bForbidNavigation, bShowReset, sStyleClass) {
		return sap.ui.getCore().loadLibrary('sap.ui.fl', {
			...
			sap.ui.require([
				'sap/ui/fl/FlexControllerFactory', 'sap/ui/fl/ControlPersonalizationAPI', 'sap/ui/fl/Utils', this.getMetadataHelperPath() || "sap/ui/mdc/base/info/ContentHandler"
					...
					return new Promise(function(resolve) {
						...
						var oSelectionDialog = new SelectionDialog({
							...
							ok: function() {
								...
								var oAppComponent = Utils.getAppComponentForControl(this);
								var aPanelChanges = PanelFlexibility.createChanges(this, oAppComponent, aRuntimeChanges);
								...
								ControlPersonalizationAPI.addPersonalizationChanges({
									...
									aFlexChangesTotal = aFlexChangesTotal.concat(aFlexChanges);
									return ControlPersonalizationAPI.saveChanges(aFlexChangesTotal, oAppComponent);
								}).then(function() {
									return resolve(true);
								});
							}.bind(this),
