...
sap.ui.define(['sap/ui/core/Element', "sap/base/Log"], function(Element, Log) {
	 ...
	 * @class Base type for <code>fieldFelp</code> association in <code>Field</code> controls.
	 ...
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
	FieldHelpBase.prototype.isOpen = function() {
	 ...
	 * @return {string|Promise} text for key. If it is not available right now (must be requested) a Promise is returned.
	 *
	 * @public
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
	 ...
	 * @param {sap.ui.model.Context} oBindingContext BindingContext of the checked field. (In Table FieldHelp might be connected to a different row.)
	 * @return {any|Promise} key for text. If it is not available right now (must be requested) a Promise is returned.
	 *
	 * @public
	 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
	 */
