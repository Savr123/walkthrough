...
sap.ui.define([
	 ...
	 */
	var ContentResource = ManagedObject.extend(NS.getName("ContentResource"), /** @lends sap.ui.vk.ContentResource.prototype */ {
		metadata: {
			properties: {
				/**
				 ...
				 */
				localMatrix: NS.getName("TransformationMatrix"),
			...
			aggregations: {
				 ...
				 */
				contentResources: NS.getName("ContentResource")
			}
		},
