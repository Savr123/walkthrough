...
sap.ui.define([
	 ...
	 * @since 1.32.0
	 */
	var SceneTree = Control.extend(NS.getName("SceneTree"), /** @lends sap.ui.vk.SceneTree.prototype */ {
		metadata: {
			library: NS.getName(),
			properties: {
				title: {
	...
	SceneTree.prototype.refresh = function() {
		...
		var getChildrenRecursively = function(tree, nodeRefs) {
			nodeRefs.forEach(function(nodeRef) {
				if (nodeRef.userData && nodeRef.userData.treeNode && nodeRef.userData.treeNode.skipIt) {
