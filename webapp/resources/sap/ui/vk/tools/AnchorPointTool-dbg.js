...
sap.ui.define([
	 ...
	 */
	var AnchorPointTool = Tool.extend(NS.getName("tools.AnchorPointTool"), /** @lends sap.ui.vk.tools.AnchorPointTool.prototype */ {
		metadata: {
			properties: {
				/**
				...
				/**
				 * If set to <code>true<code> then rotation of anchor point will be enabled
				 */
				enableRotation: {
					type: "boolean",
					defaultValue: false
