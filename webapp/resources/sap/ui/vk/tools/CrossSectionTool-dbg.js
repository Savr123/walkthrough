...
sap.ui.define([
	 ...
	 */
	var CrossSectionTool = Tool.extend(NS.getName("tools.CrossSectionTool"), /** @lends sap.ui.vk.tools.CrossSectionTool.prototype */ {
		metadata: {
		},
	...
	*/
	CrossSectionTool.prototype._prepare = function() {
		...
		if (this._viewport._loco) {
			...
			this._viewport._loco.addHandler(this._handler, 20);
			okToExec = true;
		}
