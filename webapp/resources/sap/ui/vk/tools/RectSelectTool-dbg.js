...
sap.ui.define([
	 ...
	 */
	var RectSelectTool = Tool.extend(NS.getName("tools.RectSelectTool"), /** @lends sap.ui.vk.tools.RectSelectTool.prototype */ {
		metadata: {
			properties: {
				/**
	...
	RectSelectTool.prototype.init = function() {
		...
		this.setFootprint([ NS.getName("dvl.Viewport"), NS.getName("threejs.Viewport") ]);
	};
	...
	*/
	RectSelectTool.prototype.select = function(x1, y1, x2, y2, scene, camera) {
		...
		if (this.isViewportType(NS.getName("dvl.Viewport"))) {
