...
sap.ui.define([
	 ...
	 */
	var SceneOrientationTool = Tool.extend(NS.getName("tools.SceneOrientationTool"), /** @lends sap.ui.vk.tools.SceneOrientationTool.prototype */ {
		metadata: {
			properties: {
	...
	SceneOrientationTool.prototype.setActive = function(value, activeViewport, gizmoContainer) {
		...
		this.getGizmo()._viewport = activeViewport.getImplementation ? activeViewport.getImplementation() : activeViewport;
