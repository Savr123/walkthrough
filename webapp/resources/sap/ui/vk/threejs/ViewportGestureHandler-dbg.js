...
sap.ui.define([
	...
	var ViewportGestureHandler = EventProvider.extend(NS.getName("threejs.ViewportGestureHandler"), {
		metadata: {
		},
		constructor: function(viewport) {
			...
			var ThreeJsCameraController = function(vp) {
				...
				this.zoom = function(zoomFactorScaler) {
					...
					// restriction of zoomFactor because of Pinch on Macbook trackpad
					if (zoomFactorScaler > 1.12){
						zoomFactorScaler = 1.12;
					}else if (zoomFactorScaler < 0.88){
						zoomFactorScaler = 0.88;
					}

					var zoomOutLimit = 100; // zoomout limit to 100px
	...
	ViewportGestureHandler.prototype.activateCamera = function(camera, timeInterval) {
