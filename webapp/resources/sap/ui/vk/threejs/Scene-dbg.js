...
sap.ui.define([
	 ...
	 */
	var Scene = SceneBase.extend(NS.getName("threejs.Scene"), /** @lends sap.ui.vk.threejs.Scene.prototype */ {
		metadata: {},
	...
	Scene.prototype._computeBoundingBox = function(visibleOnly, ignoreDynamicObjects) {
		var boundingBox = new THREE.Box3();
		if (this._scene) {
			this._scene._expandBoundingBox(boundingBox, visibleOnly, ignoreDynamicObjects);
		}
		return boundingBox;
	};
	 ...
	 * @param {float} duration duration of sequence
	 *
	 * @returns {sap.ui.vk.AnimationSequence} An empty animation sequence
	 * @public
	 */
	Scene.prototype.createAnimationSequence = function(id, name, duration) {
		var sequence = new AnimationSequence(id, name, duration);
		this._animationSequenceMap.set(id, sequence);
		return sequence;
	};
	 ...
	 * @public
	 */
	Scene.prototype.getAnimationSequence = function(id) {
		var sequence = this._animationSequenceMap.get(id);
		return sequence;
	};
