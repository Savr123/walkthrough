...
sap.ui.define([
	 ...
	 */
	var ContentDeliveryService = ManagedObject.extend(NS.getName("threejs.ContentDeliveryService"), {
		metadata: {
			properties: {
				/**
	...
	ContentDeliveryService.prototype.loadView = function(sceneId, viewId, type) {
		...
		var that = this;
		return this._loader.requestView(sceneId, type, viewId).then(function(view) {
	...
	ContentDeliveryService.prototype.updatePlaybacks = function(sceneId, viewId, playbackIds) {
		...
		return this._loader.requestView(sceneId, "static", viewId, playbackIds).then(function(view) {
