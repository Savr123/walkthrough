...
sap.ui.define([
	 ...
	 */
	var Billboard = BaseObject.extend(NS.getName("threejs.Billboard"), /** @lends sap.ui.vk.threejs.Billboard.prototype */ {
		metadata: {
			properties: {
				node: {
				...
				encoding: {
					type: NS.getName("BillboardTextEncoding"),
				...
				style: {
					type: NS.getName("BillboardStyle"),
					defaultValue: BillboardStyle.None
				},
				borderLineStyle: {
					type: NS.getName("BillboardBorderLineStyle"),
				...
				horizontalAlignment: {
					type: NS.getName("BillboardHorizontalAlignment"),
				...
				coordinateSpace: {
					type: NS.getName("BillboardCoordinateSpace"),
