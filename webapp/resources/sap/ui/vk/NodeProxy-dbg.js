...
sap.ui.define([
	 ...
	 * @since 1.32.0
	 */
	var NodeProxy = ManagedObject.extend(NS.getName("NodeProxy"), /** @lends sap.ui.vk.NodeProxy.prototype */ {
		metadata: {
			properties: {
				/**
				 ...
				 */
				localMatrix: {
					type: NS.getName("TransformationMatrix"),
					bindable: "bindable"
				},
