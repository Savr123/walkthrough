...
sap.ui.define([
	 ...
	 */
	var ContentConnector = Element.extend(NS.getName("ContentConnector"), /** @lends sap.ui.vk.ContentConnector.prototype */ {
		metadata: {
			library: NS.getName(),
			...
			aggregations: {
				 ...
				 */
				contentManagers: {
					type: NS.getName("ContentManager"),
					visibility: "hidden"
				}
			},
	...
	var resolvers = [
		{
			...
			dimension: 3,
			contentManagerClassName: NS.getName("threejs.ContentManager")
		},
		{
			pattern: /^vdsl?$/,
			dimension: 3,
			contentManagerClassName: NS.getName("dvl.ContentManager")
		},
		{
			pattern: /^(png|jpg|jpeg|gif|bmp|tiff?|svg)$/,
			dimension: 2,
			contentManagerClassName: NS.getName("ImageContentManager")
		},
		{
			pattern: "cgm",
			dimension: 2,
