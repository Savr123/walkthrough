...
sap.ui.define([
	 ...
	 * @since 1.32.0
	 */
	var GraphicsCore = EventProvider.extend(NS.getName("dvl.GraphicsCore"), /** @lends sap.ui.vk.dvl.GraphicsCore.prototype */ {
		metadata: {
			publicMethods: [
		...
		constructor: function(runtimeSettings, webGLContextAttributes) {
			...
			var settings = jQuery.extend({}, runtimeSettings, {
				filePackagePrefixURL: jQuery.sap.getResourcePath(NS.getPath("ve")) + "/"
			});
