...
sap.ui.define([
	 ...
	 * @since 1.50.0
	 */
	var ContentManager = ContentManagerBase.extend(NS.getName("dvl.ContentManager"), /** @lends sap.ui.vk.dvl.ContentManager.prototype */ {
		metadata: {
			library: NS.getName()
		}
	});
	...
	ContentManager.prototype._getGraphicsCore = function() {
		...
		return new Promise(function(resolve, reject) {
			if (that._graphicsCore) {
				...
				sap.ui.require([ NS.getPath("dvl/GraphicsCore") ], function(GraphicsCore) {
						...
						function(sourcesFailedToDownload) {
							...
							graphicsCore.updateSceneTreeAsync(loadedScene, contentResources)
								.then(function(data) {
									...
									// also be used.
									sap.ui.require([
										NS.getPath("dvl/Viewport"),
										NS.getPath("dvl/ViewStateManager")
									], function() {
