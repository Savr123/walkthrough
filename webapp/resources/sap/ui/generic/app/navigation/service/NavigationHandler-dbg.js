...
sap.ui.define([
	 ...
	 *        method.<br>
	 *        <b>Note:</b> The check for sensitive data requires that the OData metadata has already been loaded completely.<br>
	 ...
	 *        The NavigationHandler removes any properties annotated as <code>com.sap.vocabularies.Analytics.v1.Measure</code> from the data stored
	 *        as xapp data. <br>
	 *        <b>Note:</b> The same restriction as for <code>IsPotentiallySensitive</code> also applies to the measure check.
