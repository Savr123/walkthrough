...
sap.ui.define([
	...
	/**
	 * Constructs a utility class to analyze the OData metadata document ($metadata) to resolve SAP annotations.
	 *
	 * <b>Note:</b> Please ensure that the promise returned by {@link sap.ui.model.odata.ODataMetaModel#loaded loaded} is resolved before using this class.
	 *
	 * @constructor
	...
	MetadataAnalyser.prototype.getMultiUnitBehaviorEnabled = function() {
		...
		return MetadataAnalyser.isTermDefaultTrue(oEntityContainer && oEntityContainer["com.sap.vocabularies.UI.v1.ApplyMultiUnitBehaviorForSortingAndFiltering"]);
	};
