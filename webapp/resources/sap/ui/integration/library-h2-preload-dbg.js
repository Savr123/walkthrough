 ...
 */
sap.ui.predefine('sap/ui/integration/library',["sap/ui/base/DataType","sap/ui/Global","sap/ui/core/library","sap/m/library","sap/f/library"],function(D){"use strict";sap.ui.getCore().initLibrary({name:"sap.ui.integration",version:"1.69.1",dependencies:["sap.ui.core","sap.f","sap.m"],types:["sap.ui.integration.CardActionType","sap.ui.integration.CardDataMode"],controls:["sap.ui.integration.widgets.Card","sap.ui.integration.host.HostConfiguration"],elements:[],noLibraryCSS:true,customTags:{"card":"sap/ui/integration/widgets/Card","host-configuration":"sap/ui/integration/host/HostConfiguration"},defaultTagPrefix:"ui"});var t=sap.ui.integration;t.CardActionType={Navigation:"Navigation"};t.CardDataMode={Active:"Active",Inactive:"Inactive"};return t;});
sap.ui.require.preload({
	"sap/ui/integration/manifest.json":'{"_version":"1.9.0","sap.app":{"id":"sap.ui.integration","type":"library","embeds":[],"applicationVersion":{"version":"1.69.1"},"title":"SAPUI5 library with integration-related controls.","description":"SAPUI5 library with integration-related controls.","ach":"CA-UI5-CTR","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":[]},"sap.ui5":{"dependencies":{"minUI5Version":"1.69","libs":{"sap.ui.core":{"minVersion":"1.69.1"},"sap.f":{"minVersion":"1.69.1"}}},"library":{"i18n":"messagebundle.properties","css":false,"content":{"controls":["sap.ui.integration.widgets.Card","sap.ui.integration.host.HostConfiguration"],"elements":[],"types":["sap.ui.integration.CardActionType","sap.ui.integration.CardDataMode"]}}}}'
},"sap/ui/integration/library-h2-preload"
);
sap.ui.loader.config({depCacheUI5:{
"sap/ui/integration/designtime/controls/BaseEditor.js":["sap/base/util/ObjectPath.js","sap/base/util/deepClone.js","sap/base/util/merge.js","sap/ui/core/Control.js","sap/ui/integration/designtime/controls/Config.js","sap/ui/model/BindingMode.js","sap/ui/model/json/JSONModel.js"],
"sap/ui/integration/designtime/controls/Config.js":["sap/base/util/merge.js","sap/ui/base/ManagedObject.js","sap/ui/integration/designtime/controls/DefaultConfig.js"],
"sap/ui/integration/designtime/controls/PropertyEditor.js":["sap/m/Label.js","sap/ui/core/Control.js"],
"sap/ui/integration/designtime/controls/propertyEditors/StringEditor.js":["sap/ui/integration/designtime/controls/PropertyEditor.js"],
