    ...
    function (UIComponent, SettingsDialogConstants, Router, jQuery,
        ...
        return UIComponent.extend("sap.ovp.app.Component", {
            ...
            createXMLView: function (ovpConfig) {
                ...
                var bEnableFiori3 =  Config.last("/core/shell").enableFiori3;
                if (bEnableFiori3 === false) {
                    uiModel.setProperty("/enableFiori3", false);
                } else {
                    uiModel.setProperty("/enableFiori3", true);
                }
