sap.ui.define([
    ...
    "sap/ovp/changeHandler/PersonalizationBlank"
], function (HideCardContainer, UnhideCardContainer, UnhideControl, RemoveCardContainer, OverlayRegistry,
             ComponentContainer, MessageToast, SettingsConstants, SettingsUtils, CommonUtils, OvpResources, PersonalizationBlank) {
    "use strict";
    return {
        "moveControls": {
        ...
        "viewSwitch": PersonalizationBlank,
        "visibility": PersonalizationBlank,
        "dragOrResize": PersonalizationBlank
    };
}, /* bExport= */true);