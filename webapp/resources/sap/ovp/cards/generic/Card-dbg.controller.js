sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
        ...
        "sap/ui/generic/app/library", "jquery.sap.global", "sap/ovp/app/resources",
    ...
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils) {
        "use strict";
        return Controller.extend("sap.ovp.cards.generic.Card", {
            ...
            onHeaderClick: function (oEvent) {
                var sNavMode = oEvent.ctrlKey || oEvent.metaKey || OVPUtils.bCRTLPressed ? OVPUtils.constants.explace : OVPUtils.constants.inplace;
                /*
