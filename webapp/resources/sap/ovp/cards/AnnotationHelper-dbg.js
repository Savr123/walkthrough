...
sap.ui.define(["jquery.sap.global", "sap/ui/core/format/NumberFormat", "sap/ui/core/format/DateFormat",
        ...
        "sap/ui/model/analytics/odata4analytics", "sap/ui/generic/app/navigation/service/SelectionVariant", "sap/ovp/app/resources"],
    function (jQuery, NumberFormat, DateFormat, CommonUtils, OdataAnnotationHelper,
              FilterOperator, Device, odata4analytics, SelectionVariant, OvpResources) {
        ...
        function calculateTrendDirection(aggregateValue, referenceValue, downDifference, upDifference, bEnableFiori3) {
            ...
            if (!upDifference && (aggregateValue - referenceValue >= 0)) {
                return (bEnableFiori3 === false) ? "sap-icon://trend-up" : "Up";
            }
            if (!downDifference && (aggregateValue - referenceValue <= 0)) {
                return (bEnableFiori3 === false) ? "sap-icon://trend-down" : "Down";
            }
        ...
        function formThePathForTrendIcon(iContext, oDataPoint, bEnableFiori3) {
