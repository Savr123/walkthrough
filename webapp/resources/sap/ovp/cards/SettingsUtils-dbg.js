sap.ui.define([
        ...
        "sap/ovp/app/OVPUtils"
                 ...
                 JSONModel, ResourceModel, OvpResources, OVPUtils) {
        "use strict";
            ...
            switch (sElement) {
                ...
                case "selectionPresentationVariant":
                    if (!oCardProperties.addNewCard) {
                        ...
                        bVisibilityValue = showSubFields && bModelSelected && bCardSelected && bEntitySelected && checkIfCardTemplateHasProperty(oCardProperties.template, "selecionOrPresentation") &&
                            !!(jQuery.isArray(oCardProperties.selectionPresentationVariant) && oCardProperties.selectionPresentationVariant.length);
                    }
                    break;
                case "KPI":
                ...
                case "selectionVariant":
                    if (!oCardProperties.addNewCard) {
                        ...
                        bVisibilityValue = showSubFields && bModelSelected && bCardSelected && bEntitySelected && !(jQuery.isArray(oCardProperties.selectionPresentationVariant) && oCardProperties.selectionPresentationVariant.length)
