sap.ui.define([ "jquery.sap.global", "sap/ui/core/mvc/Controller",
    ...
    "sap/m/IconTabFilter", "sap/ui/core/mvc/ViewType", "sap/m/Dialog", "sap/m/Button", "sap/ovp/cards/CommonUtils", "sap/ui/Device", "sap/ovp/app/resources", "sap/ovp/app/OVPUtils"],
    ...
    function(jQuery, Controller, JSONModel,
            ...
            Toolbar, IconPool, IconTabBar, IconTabFilter, ViewType, Dialog, Button, CommonUtils, Device, OvpResources, OVPUtils) {
    "use strict";
    ...
    onDatasourceComboboxChanged: function(oEvent) {
        ...
        if (!settingsUtils.newDataSource) {
            ...
            for (var i = 0; i < aDataSources.length; i++) {
                if (aDataSources[i].Title === this._oCardManifestSettings.model) {
                    this._oCardManifestSettings.metaModel = aDataSources[i].getMetaModel();
                }
            }
        ...
        */
        onParameterDelete: function(oEvent) {
            ...
            oCardPropertiesModel.setProperty("/aAllStaticParameters", aStaticParameters);
            if (!jQuery.sap.equal(this._oCardManifestSettings.staticParameters, this._oOriginalCardManifestSettings.staticParameters)) {
                this.setEnablePropertyForResetAndSaveButton(true);
            }
            this.getView().getModel().refresh();
        },
        ...
        */
        onActionDelete: function(oEvent) {
            ...
            if (!jQuery.sap.equal(this._oCardManifestSettings.objectStreamCardsSettings,this._oOriginalCardManifestSettings.objectStreamCardsSettings)) {
                this.setEnablePropertyForResetAndSaveButton(true);
            }
        },
