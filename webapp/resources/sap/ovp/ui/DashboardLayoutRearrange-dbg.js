sap.ui.define(["sap/ovp/ui/UIActions", "sap/ui/Device", "jquery.sap.global"],
    ...
    Rearrange.prototype._dragMoveHandler = function (actionObject) {
        if (actionObject.element) {
            ...
            if (this.layoutUtil.getDashboardLayoutModel().uiModel.getProperty("/enableFiori3")) {
                ...
                if (document.getElementsByClassName("sapUshellShellHeadCenter")[0]) {
                    uShellHeadHeight = document.getElementsByClassName("sapUshellShellHeadCenter")[0].offsetHeight;
                }
            }
            var viewHeight = viewElement.offsetHeight;
            var viewRect = viewElement.getBoundingClientRect();
